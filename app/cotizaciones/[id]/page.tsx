...
export default function CotizacionPage() {
  ...
  const abrirPdf = async () => {
    ...
    try {
      ...
      // Si el fetch tarda, iOS puede revocar el "user activation" que
      // navigator.share() necesita antes de que el PDF este listo, y falla
      // con NotAllowedError aunque el usuario no haya cancelado nada — en
      // ese caso se abre el PDF directo en vez de mostrar un error.
