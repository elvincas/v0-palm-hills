            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-[#1a1a18] text-left">
                  <th className="pb-2 font-bold text-[#1a1a18] text-xs uppercase tracking-wide">Cant.</th>
                  <th className="pb-2 font-bold text-[#1a1a18] text-xs uppercase tracking-wide">SKU</th>
                  <th className="pb-2 font-bold text-[#1a1a18] text-xs uppercase tracking-wide">Descripción</th>
                  <th className="pb-2 font-bold text-[#1a1a18] text-xs uppercase tracking-wide text-right">
                    Precio
                  </th>
                  <th className="pb-2 font-bold text-[#1a1a18] text-xs uppercase tracking-wide text-right">
                    Monto
                ...
                {lineas.length ? (
                  lineas.map((l, i) => (
                    <tr key={i} className="border-b border-gray-200">
                      <td className="py-2.5 text-gray-700">{l.qty}</td>
                      <td className="py-2.5 text-gray-400 font-mono text-xs">{l.sku || "—"}</td>
                      <td className="py-2.5 text-gray-800">{l.prodNom}</td>
                      <td className="py-2.5 text-gray-700 text-right">{fmt(l.precio)}</td>
                      <td className="py-2.5 text-gray-800 text-right font-medium">{fmt(l.qty * l.precio)}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
