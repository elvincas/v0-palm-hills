...
export default function FacturaPage() {
  ...
  return (
    <div className="min-h-screen print:min-h-0 print:h-auto bg-[#f0efe9]">
      ...
      {/* Invoice document — <thead> nativo repite el header en cada hoja al imprimir */}
      <div className="factura-doc max-w-3xl mx-auto p-4 sm:p-8">
        <div className="bg-white rounded-2xl print:rounded-none shadow-sm print:shadow-none border border-gray-200 print:border-0 overflow-hidden print:overflow-visible">
          <table className="w-full text-sm border-collapse">
            <thead>
              {/* Fila 1: encabezado completo de la factura */}
              <tr>
              ...
              <tr className="border-b-2 border-[#1a1a18] text-left">
                <th className="pl-6 sm:pl-10 pb-2 pt-4 font-bold text-[#1a1a18] text-[11px] uppercase tracking-wide">Qty.</th>
                <th className="pb-2 pt-4 font-bold text-[#1a1a18] text-[11px] uppercase tracking-wide">SKU</th>
                <th className="pb-2 pt-4 font-bold text-[#1a1a18] text-[11px] uppercase tracking-wide">Description</th>
                <th className="pb-2 pt-4 font-bold text-[#1a1a18] text-[11px] uppercase tracking-wide text-right">Price</th>
                <th className="pr-6 sm:pr-10 pb-2 pt-4 font-bold text-[#1a1a18] text-[11px] uppercase tracking-wide text-right">Amount</th>
              </tr>
            </thead>
            <tbody>
              {lineas.length ? lineas.map((l, i) => {
                ...
                return (
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-[#e3e9da]"}>
                    <td className="pl-6 sm:pl-10 py-2 text-gray-700 text-xs">{l.qty}</td>
                    ...
                    <td className="pr-6 sm:pr-10 py-2 text-right text-xs">
                      {tieneDescuento ? (
                        <div className="flex flex-col items-end leading-tight">
          ...
          {/* Totales */}
          <div className="px-6 sm:px-10 py-4 border-t border-gray-100">
