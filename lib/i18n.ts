...
const ES: Record<string, string> = {
  ...
  "Remaining": "Faltan",
  "of": "de",
  // Pronostico de ventas (2026-08-01)
  "Pace": "Ritmo",
  "Forecast": "Pronóstico",
  "day": "día",
  "Early estimate": "Estimado temprano",
  "over goal": "sobre la meta",
  "on pace": "a buen ritmo",
  "short": "por debajo",
  "need": "necesitas",
  ...
  // ── Reports hub (2026-08-01) ──
  "Reports": "Reportes",
  "Sales": "Ventas",
  "Money": "Dinero",
  "Sales Analysis": "Análisis de Ventas",
  "Dormant Clients": "Clientes Dormidos",
  "Buying Frequency": "Frecuencia de Compra",
  "Best Day": "Mejor Día",
  "Who Buys This": "Quién Compra Esto",
  "Who buys this": "Quién compra esto",
  "Aging Report": "Reporte de Cartera",
  "Commissions": "Comisiones",
  "Sales vs Collected": "Ventas vs Cobrado",
  "Missing Stock": "Faltantes",
  "Smart Reorder": "Reposición",
  ...
  "invoices": "facturas",
  "No sales in this period.": "Sin ventas en este periodo.",
  "No detail available.": "Sin detalle disponible.",
  "Custom": "A la medida",
  "This Month": "Este Mes",
  ...
  "This Year": "Este Año",
  // Dormant / Frequency
  "Clients who used to buy regularly and stopped. Sorted by how much they used to spend per month — the biggest loss first.":
    "Clientes que compraban seguido y dejaron de hacerlo. Ordenados por cuánto gastaban al mes — la pérdida más grande primero.",
  "Last": "Última",
  "last": "última",
  "orders": "órdenes",
  "mo": "mes",
  ...
  "Win back": "Recuperar",
  "We haven't heard from you in a while — can we bring you an order this week?":
    "Hace tiempo no sabemos de usted — ¿le llevamos un pedido esta semana?",
  "No dormant clients — everyone is buying.": "Sin clientes dormidos — todos están comprando.",
  "Days silent": "Días en silencio",
  "Last order": "Última orden",
  "Was buying (per month)": "Compraba (por mes)",
  "Lifetime": "Histórico",
  "How often each client buys, and who is already late. Only clients with 3+ orders — with fewer, the average means nothing.":
    "Cada cuánto compra cada cliente y quién ya se atrasó. Solo clientes con 3+ órdenes — con menos, el promedio no dice nada.",
  "Every": "Cada",
  "Status": "Estado",
  "late": "tarde",
  "due now": "toca ya",
  "in": "en",
  "Not enough purchase history yet.": "Aún no hay suficiente historial de compras.",
  "Buys every (days)": "Compra cada (días)",
  "Due in (days)": "Toca en (días)",
  // Best Day
  "Which day of the week actually sells. Useful to plan the route and the deliveries.":
    "Qué día de la semana vende de verdad. Sirve para planear la ruta y las entregas.",
  "Best day": "Mejor día",
  "Day": "Día",
  "Sunday": "Domingo",
  "Monday": "Lunes",
  ...
  "Saturday": "Sábado",
  // Who buys this
  "Pick a product and see exactly who buys it, how much and when they last did.":
    "Elige un producto y ve exactamente quién lo compra, cuánto y cuándo fue la última vez.",
  "Search product by name, SKU or brand": "Buscar producto por nombre, SKU o marca",
  "Nobody has bought this product yet.": "Nadie ha comprado este producto todavía.",
  "Times": "Veces",
  // Sales vs Collected
  "Invoiced vs actually collected in the period. Selling is not the same as getting paid.":
    "Facturado vs realmente cobrado en el periodo. Vender no es lo mismo que cobrar.",
  "By salesperson": "Por vendedor",
  "By client": "Por cliente",
  "Invoiced": "Facturado",
  "Collected": "Cobrado",
  "Note: collected counts every payment received in the period, including payments for invoices billed earlier — so the % can go over 100.":
    "Ojo: cobrado cuenta todo pago recibido en el periodo, incluidos pagos de facturas más viejas — por eso el % puede pasar de 100.",
